...
mcmc_smpl <- mcmc(mod_fit, n_samples = 5000, thin = 5, warmup = 5000,
...
Here are the fitted versus observed values for each of the `r MM` columns in the loadings matrix $\mathbf{Z}$.
