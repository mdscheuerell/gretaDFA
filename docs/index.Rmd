...
mcmc_smpl <- mcmc(mod_fit, verbose = FALSE,
                  sampler = hmc(Lmin = 1, Lmax = 50, epsilon = 0.01, diag_sd = 1),
                  warmup = 2000, n_samples = 4000, thin = 10, chains = 1,
                  initial_values = initials(RR_est = runif(1, 0.1, 0.5),
