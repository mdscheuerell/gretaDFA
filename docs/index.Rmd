...
mcmc_smpl <- mcmc(mod_fit, n_samples = 2000, thin = 2, warmup = 1000,
                  chains = 1, verbose = FALSE,
                  hmc(Lmin = 2, Lmax = 100, epsilon = 0.05))
```
...
Here is an estimate of the observation variance (recall that the true value is `r obs_var`).
