 ...
 * 1 for the 1:(M-1) diagonal elements;
 * 2 for the M^th^ diagonal element; and
 * 3 for all of the subdiagonal elements.
...
mcmc_smpl <- mcmc(mod_fit, n_samples = 50000, thin = 50, warmup = 20000,
                  chains = 1, verbose = FALSE,
                  hmc(Lmin = 1, Lmax = 50, epsilon = 0.001, diag_sd = 0.1))
```
