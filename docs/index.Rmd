...
mcmc_smpl <- mcmc(mod_fit,
                  sampler = hmc(Lmin = 5, Lmax = 10, epsilon = 0.1, diag_sd = 1),
...
Here is the correlation between the actual $\mathbf{Z}$ and the estimated $\hat{\mathbf{Z}}$.
